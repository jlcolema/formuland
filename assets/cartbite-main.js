if(!window.initVar){
  window.initVar = {
    ...
    meta: {},
    vapidKey: "BNLVX5YM067lZnaGcCMXfA9TPI7TrQzI8vD0MjEUbO30kdfFrZ6AKz_XV1i958Fd9D5vfbjat3uecMg6di1vx2o",
    clientId: "J2NX9IXVG8XLCC19UC2EGYP9",
    pushOptInSetting: {"delay":86400,"message":{"body":"We will notify you about new products and exclusive promotions","title":"Never miss a sale","buttons":[{"label":"Later","order":1},{"label":"Allow","order":2}],"iconUrl":"https://cdn.shopify.com/s/files/1/0647/7493/0651/t/4/assets/grow-FEQ7SWFISAZ5IYRUTNP3AYAL.jpeg"},"isEnabled":false,"showModal":true,"initialDelay":10},
    subscriberId: '',
    stockFulFilledPushCampaign: {
      isActive: true,
      uniqueId: '6Z272RJ3KUM8L8V5X79P3UJX'
    },
    stockFulFilledEmailCampaign: {
      isActive: true,
      uniqueId: 'GXEVDPWWNMUXF9B64325JYSI'
    },
    stockFulFilledSmsCampaign: {
      isActive: true,
      uniqueId: 'U3RLYQBEJ7JYEYBETZS4YIT1'
    },
    priceDropPushCampaign: {
      isActive: true,
      uniqueId: 'U5P1F2XMT3DFNP58S4DJUFMS',
    },
    priceDropEmailCampaign: {
      isActive: true,
      uniqueId: 'D9WLD15RR2LB4SZ6JHXRTXZQ',
    },
    priceDropSmsCampaign: {
      isActive: true,
      uniqueId: '3XFEATSABI35AWTYSYRP1KRX',
    },
    stockWidget: {
  ...
  window.onload = function () {
    window.growCampaignPopUp = new Vue({
      ...
      data: {
        ...
        emailWorkflowUniqueId: "GXEVDPWWNMUXF9B64325JYSI",
        smsWorkflowUniqueId: "U3RLYQBEJ7JYEYBETZS4YIT1",
