...
const copyNode = document.querySelector('.loop-selling-plan-selector')
              const clone = copyNode.cloneNode(true);
               document.getElementById("loop-copy-container").appendChild(clone);
//Global functions
